...
| [14](#decision-14) | Centralisation des appels API via un module client unique  | 2026-07-28 |
| [15](#decision-15) | Composant d'ajout et de modification d'un point d'intérêt très similaire | 2026-07-28 |
...
## Décision 14 - Centralisation des appels API via un module client unique {#decision-14}
...
## Décision 15 - Composant d'ajout et de modification d'un point d'intérêt très similaire {#decision-15}
